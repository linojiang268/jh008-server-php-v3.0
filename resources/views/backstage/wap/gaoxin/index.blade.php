...
<head>
    ...
    <!-- <link rel="stylesheet" href="/static/gaoxin/css/normalize.css">
    <link rel="stylesheet" href="/static/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" href="/static/gaoxin/css/main.css">
    <link rel="stylesheet" href="/static/gaoxin/css/modal.css"> -->
    ...
    <!--<script src="{{$prefix}}/static/gaoxin/js/build/JSXTransformer.js"></script>-->
    ...
    <!--<script src="/static/gaoxin/js/common.js"></script>
    <script src="/static/gaoxin/js/server.js"></script>
    <script src="/static/gaoxin/js/ajaxfileuploader.js"></script>-->
</head>
</head>
<body>
...
<script>
    ...
    if ((is_weixin && !openId && wechat_session == 0)) {
        location.href = '/wap/wechat/oauth/go?redirect_url='+ location.origin +'/wap/gaoxin&is_scope_userinfo=1';
    }
</script>
...
<script type="text/jsx" src="/static/gaoxin/js/download.js"></script>
...
<script type="text/javascript" src="{{$prefix}}/static/gaoxin/js/bundle.min.js?v=3337"></script>

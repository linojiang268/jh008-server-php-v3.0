        ...
        return (
            <div className="detailPanel">
                ...
                <div className="detailPanel-content">
                    ...
                    <p className="tc introduce-tip1">本次大赛由"集合"App独家承办网络人气票选</p>
                    <p className="tc introduce-tip1">每人每天能点赞<span className="introduce-tip-sel">5</span>次（集合App内<span className="introduce-tip-sel">4</span>次，微信分享<span className="introduce-tip-sel">1</span>次）</p>

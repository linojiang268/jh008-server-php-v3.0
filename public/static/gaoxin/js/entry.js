var EntryPanel = React.createClass({
    ...
    submitHandler: function() {
        ...
        if ( submitBtn.hasClass('disabled') ) {
            ...
            result.love_bus_apply  = parent.find('input[name="love_bus_apply"]').prop('checked') ? 1 : 0,
        ...
        return (
            <div ref="entryForm" className="entryForm">
                ...
                <div className="entryForm-item">
                    ...
                    <label htmlFor="guest_apply" className="entryForm-name entry-shangtai w125">申请成为上台嘉宾</label>
                </div>

                <div className="entryForm-item">
                    <input type="checkbox" className="guest-checkbox" id="love_bus_apply" name="love_bus_apply" />
                    <label htmlFor="love_bus_apply" className="entryForm-name entry-Transportation w125">乘坐组委会提供的免费爱情大巴（地铁一号线广都站外上车）</label>
                </div>

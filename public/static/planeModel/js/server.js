...
server.attendantList = function (data, callback) {
    return send('get', '/wap/planemodel/approved/list', data, callback);
};

// 申请注册
server.enroll = function (data, callback) {
    return send('post', '/wap/planemodel/enroll', data, callback);
};

// 个人详情
server.attendantDetail = function (data, callback) {
    return send('get', '/wap/planemodel/detail', data, callback);
};

// 投票
server.attendantVote = function (data, callback) {
    return send('post', '/wap/planemodel/vote', data, callback);
};
...
server.pendingList = function (data, callback) {
    return send('get', '/planemodel/pending/list', data, callback);
};

// 已通过列表
server.approvedList = function (data, callback) {
    return send('get', '/planemodel/approved/list', data, callback);
};

// 通过
server.approve = function (data, callback) {
    return send('post', '/planemodel/approve', data, callback);
};

// 拒绝
server.remove = function (data, callback) {
    return send('post', '/planemodel/remove', data, callback);
};

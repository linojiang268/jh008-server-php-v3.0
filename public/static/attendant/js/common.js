(function(){
    ...
    var Android_download_url = 'http://dev.file.jhla.com.cn/app/android/jihe.apk',
        Ios_download_url = 'itms-services://?action=download-manifest&url=https://dl.jhla.com.cn/production/dl/app/ios/jihe_production.plist',
        ...
        return function(type) {
            ...
            if (type == 'weixin') {
                content =   '<div class="mask-guide clearfix">' +
                            ...
                            '</div>' +
                            '<span class="mask-tip">点击右侧按钮，选择"在浏览器中打开"</span>'; 
            } else {

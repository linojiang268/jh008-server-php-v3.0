...
server.attendantList = function (data, callback) {
    return send('get', '/wap/attendant/approved/list', data, callback);
};

// 申请注册
server.enroll = function (data, callback) {
    return send('post', '/wap/attendant/enroll', data, callback);
};

// 个人详情
server.attendantDetail = function (data, callback) {
    return send('get', '/wap/attendant/detail', data, callback);
};

// 投票
server.attendantVote = function (data, callback) {
    return send('post', '/wap/attendant/vote', data, callback);
};
...
server.pendingList = function (data, callback) {
    return send('get', '/attendant/pending/list', data, callback);
};

// 已通过列表
server.approvedList = function (data, callback) {
    return send('get', '/attendant/approved/list', data, callback);
};

// 通过
server.approve = function (data, callback) {
    return send('post', '/attendant/approve', data, callback);
};

// 拒绝
server.remove = function (data, callback) {
    return send('post', '/attendant/remove', data, callback);
};
